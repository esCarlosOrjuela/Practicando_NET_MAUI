...
namespace Aprendiendo_Net_MAUI.Mvvm.Views.CodeQuotes;
...
public partial class MainPage : ContentPage
{
    ...
    void btnGenerateQuote_Clicked(System.Object sender, System.EventArgs e)
    {
        ...
        var startColor = System.Drawing.Color.FromArgb(random.Next(0, 256),
                                                       random.Next(0, 256),
                                                       random.Next(0, 256));

        var endColor = System.Drawing.Color.FromArgb(random.Next(0, 256),
                                                       random.Next(0, 256),
                                                       random.Next(0, 256));

        /// Instalamos el Nuget ColorUtility
        ...
        gridContainer.Background = gradient;
